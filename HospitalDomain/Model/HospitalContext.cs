...
namespace HospitalDomain.Model
{
    public partial class HospitalContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=Admin\\SQLEXPRESS; Database=Hospital; Trusted_Connection=True; TrustServerCertificate=True; MultipleActiveResultSets=true");
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Id).HasName("PK__appointment__3213E83FBAFA03D0");
            ...
            modelBuilder.Entity<Department>(entity =>
            {
                ...
                entity.HasKey(e => e.Id).HasName("PK__department__3213E83FB05AEE6C");
                ...
                entity.Property(e => e.Name)
                    .HasMaxLength(20)
                    .IsUnicode(false)  // This ensures it's stored as non-Unicode
                    .HasColumnName("name");
