...
namespace HospitalDomain.Migrations
{
    ...
    [Migration("20250321150911_addReceipt2")]
    partial class addReceipt2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HospitalDomain.Model.Appointment", b =>
                {
                    ...
                    b.Property<int?>("ReceiptNavigationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReceiptNavigationId");
            ...
            modelBuilder.Entity("HospitalDomain.Model.AppointmentChangeHistoryModel", b =>
                {
                    ...
                    b.HasKey("AppointmentId", "ChangeTime");
            ...
            modelBuilder.Entity("HospitalDomain.Model.Doctor", b =>
                {
                    ...
                    b.Property<string>("SignaturePictireUrl")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HospitalDomain.Model.Appointment", b =>
                {
                    ...
                    b.HasOne("HospitalDomain.Model.ReceiptModel", "ReceiptNavigation")
                        .WithMany()
                        .HasForeignKey("ReceiptNavigationId");
